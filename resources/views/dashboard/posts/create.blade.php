...
@section('content')
	...
	<div class="m-portlet">
		...
		<!--begin::Form-->
        <form method="POST" action="{{route('Posts.store')}}" enctype="multipart/form-data" class="m-form">
            @csrf
			<div class="m-portlet__body">
				<div class="m-form__section m-form__section--first">
					...
					<div class="form-group m-form__group">
						<label>Title:</label>
						<input name="title" type="text" class="form-control m-input"  value="{{ old('title') }}" placeholder="Post Title">
					...
					<div class="form-group m-form__group">
						<label>Content:</label>
						<textarea name="content" class="form-control m-input"  placeholder="Content"> {{ old('content') }} </textarea>
